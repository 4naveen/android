    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btncommit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 new SendComment().execute(comment.getText().toString());
            }
        });
    }
    ...
    private class SendComment extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("success")) {
                final Snackbar snackbar = Snackbar.make(layout, "Submitted successfully!", Snackbar.LENGTH_LONG);
                ...
                final Snackbar snackbar = Snackbar.make(layout, "Not submitted! Try Again", Snackbar.LENGTH_LONG);
                View v = snackbar.getView();
                v.setMinimumWidth(1000);
                TextView tv = (TextView) v.findViewById(android.support.design.R.id.snackbar_text);
                tv.setTextColor(Color.YELLOW);
