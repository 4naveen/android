...
import com.project.spliceglobal.recallgo.utils.HSVColorPickerDialog;
...
/*        color_picker.setOnClickListener(new View.OnClickListener() {
    ...
    *//* Set a new Listener called when user click "select" *//*
    ...
    color_picker.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            HSVColorPickerDialog cpd = new HSVColorPickerDialog( AddCategoryActivity.this, 0xFF4488CC, new HSVColorPickerDialog.OnColorSelectedListener() {
                @Override
