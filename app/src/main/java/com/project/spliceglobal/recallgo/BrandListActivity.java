...
*/
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AddBrand().execute(name.getText().toString().trim());
            }
        });
    }
    @Override
    ...
    public  void getBrand(String url) {
        ...
        MyVolleySingleton.getInstance(BrandListActivity.this).getRequestQueue().add(stringRequest);
    }
    public  void getMoreBrand(String url) {
   /*     if (next_url.equalsIgnoreCase("null")){
    ...
    private class AddBrand extends AsyncTask<String, Void, String> {
        ProgressDialog dialog;
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                url = new URL(AppUrl.ALL_BRAND_URL);
