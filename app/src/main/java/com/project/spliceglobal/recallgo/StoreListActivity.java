...
public class StoreListActivity extends AppCompatActivity {
  ...
  String store_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryArrayList.add("Daily Needs");
        categoryArrayList.add("Titan Store");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                store_text=""+parent.getItemAtPosition(position);
            }
        });
        findViewById(R.id.fab).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MaterialDialog dialog1 = new MaterialDialog.Builder(StoreListActivity.this)
                        .title("Add your own store")
